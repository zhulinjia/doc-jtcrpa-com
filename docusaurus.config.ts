...
(function() {
  ...
  try {
    ...
    if (sessionStorage.getItem('docusaurus-locale-redirect')) return;
    sessionStorage.setItem('docusaurus-locale-redirect', '1');
